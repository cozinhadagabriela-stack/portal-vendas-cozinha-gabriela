...
export function renderAdminVendorsView(vendors, vendorSummary, settings) {
    ...
    <section class="split-grid">
      <article class="card section-card">
        ...
        <div class="field-group">
          ...
          <input id="vendor-name" type="text" placeholder="Nome do vendedor" />
        </div>
        <div class="field-group">
          <label for="vendor-email">E-mail</label>
          <input id="vendor-email" type="email" placeholder="email@exemplo.com" />
        </div>
        <div class="field-grid two-columns">
          <div class="field-group">
            <label for="vendor-phone">Telefone</label>
            <input id="vendor-phone" type="text" placeholder="Telefone" />
          </div>
          <div class="field-group">
            <label for="vendor-city">Cidade</label>
            <input id="vendor-city" type="text" placeholder="Cidade" />
          </div>
        </div>
        <div class="field-grid two-columns">
          <div class="field-group">
            <label for="vendor-password">Senha inicial</label>
            <input id="vendor-password" type="password" placeholder="Senha do vendedor" />
          </div>
          <div class="field-group">
            <label for="vendor-status">Status inicial</label>
        ...
        <div class="form-actions">
          <button id="btn-save-vendor" class="btn btn-primary">Criar vendedor</button>
        </div>
      </article>
