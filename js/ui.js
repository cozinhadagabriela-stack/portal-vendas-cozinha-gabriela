      ...
      <article class="card section-card">
        ...
        ${editingStockItem ? `
          ...
          <div class="field-group">
            ...
            <input id="stock-adjust-current" type="number" min="0" value="${Number(editingStockItem.availableQuantity || 0)}" data-original-value="${Number(editingStockItem.availableQuantity || 0)}" />
          </div>
          <p class="small-text">Edite o valor real que existe em estoque e clique em salvar.</p>
          <div class="form-actions">
